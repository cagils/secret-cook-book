    ...
    >
      ...
      >
        <a>
          ...
          // height="30em"
          >
            <Box h="20em" mt={-6} mx={-6} mb={6} pos={'relative'} overflow="hidden">
              <Image
                src={recipe?.photo}
            ...
            <Stack>
              ...
              <Heading color={mode('pink.700', 'pink.200')} fontSize={'2xl'} fontFamily={'body'} as="h3">
                {recipe.title}
              </Heading>
              <Text
                overflow="hidden"
            ...
            <Stack color={mode('pink.500', 'pink.400')} mt={6} direction={'column'} spacing={0} fontSize={'sm'}>
              <Text fontWeight={'bold'}>Difficulty: {recipe.difficulty}</Text>
              <Stack direction={'row'}>
                <Text fontWeight={'bold'}>Ingredients: </Text>
                <Text fontWeight={'medium'}>
                  {recipe.ingredients.map((g) => `${g.groupName}: ` + g.list.length + ' ')}
                </Text>
              </Stack>
